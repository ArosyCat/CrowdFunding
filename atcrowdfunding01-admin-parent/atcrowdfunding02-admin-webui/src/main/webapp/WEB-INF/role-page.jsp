...
<script type="text/javascript">
    ...
    $(function (){
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (result == "SUCCESS") {
                        ...
                        // 将页码定位到原来的页码，因为generatePage()中已经有当前页码定位的功能实现了，所以直接调用这个函数即可
                        // 重新加载分页数据
                        generatePage();
                    }
                    if (result == "FAILED") {
        ...
        // 临时测试组
        // var roleArray = [{"roleId":4,"roleName":"aaa"},{"roleId":5,"roleName":"bbb"}];
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <button id="showAddModelBtn" type="button" class="btn btn-primary" style="float:right;"><i class="glyphicon glyphicon-plus"></i> 新增
                </button>
                <br>
                <hr style="clear:both;">
