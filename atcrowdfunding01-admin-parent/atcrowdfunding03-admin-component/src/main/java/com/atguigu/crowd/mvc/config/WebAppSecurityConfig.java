...
/**
 * Spring Security的配置类，Spring Security需要的所有配置可以在这里面进行配置
 *
 * @author zehao
...
//    }
    ...
    protected void configure(HttpSecurity security) throws Exception {
        ...
        security
                ...
                .permitAll()
                .antMatchers("/font/**")        // 针对静态资源进行设置，无条件访问
                .permitAll()
...
//                .hasRole("经理")                             // 要求具备经理角色
                .access("hasRole('经理') or hasAuthority('user:get')")    // 要求具备“经理”角色和“user:get”权限二者之一可以访问
                .anyRequest()                                // 针对其他请求
                .authenticated()                             // 需要认证
                .and()
                .exceptionHandling()
